...
(function($) {
    ...
    versionSelect.on('change', function() {
		...
		/* if(this.value === 'dark'){
			//jQuery(".nav-header .logo-abbr").attr("src", ".//admin/images/logo-white.png");
			jQuery(".nav-header .logo-compact").attr("src", "/admin/images/logo-text-white.png");
			jQuery(".nav-header .brand-title").attr("src", "/admin/images/logo-text-white.png");
			
			setCookie('logo_src', './/admin/images/logo-white.png');
			setCookie('logo_src2', '/admin/images/logo-text-white.png');
		}else{
			jQuery(".nav-header .logo-abbr").attr("src", ".//admin/images/logo.png");
			jQuery(".nav-header .logo-compact").attr("src", "/admin/images/logo-text.png");
			jQuery(".nav-header .brand-title").attr("src", "/admin/images/logo-text.png");
			
			setCookie('logo_src', './/admin/images/logo.png');
			setCookie('logo_src2', '/admin/images/logo-text.png');
		} */
